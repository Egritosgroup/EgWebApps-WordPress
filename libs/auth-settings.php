...
function setAppsSettings($options, $pluginFolderName) {
    ...
    $settingsArray = array(
        ...
        'benefits_tab_info' => $options['benefits_tab_info'] ? $options['benefits_tab_info'] : '',
        ...
        'carpooling_tab_info' => $options['carpooling_tab_info'] ? $options['carpooling_tab_info'] : '',
        ...
        'epayments_tab_info' => $options['epayments_tab_info'] ? $options['epayments_tab_info'] : '',
        ...
        'kliseis_tab_info' => $options['kliseis_tab_info'] ? $options['kliseis_tab_info'] : '',
        ...
        'eidopoiitiria_tab_info' => $options['eidopoiitiria_tab_info'] ? $options['eidopoiitiria_tab_info'] : '',
        ...
        'katastimata_tab_info' => $options['katastimata_tab_info'] ? $options['katastimata_tab_info'] : '',
        ...
        'diakanonismoi_tab_info' => $options['diakanonismoi_tab_info'] ? $options['diakanonismoi_tab_info'] : '',
        ...
        'shde_tab_info' => $options['shde_tab_info'] ? $options['shde_tab_info'] : ''
    );
