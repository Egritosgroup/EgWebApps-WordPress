...
function setAppsSettings($options, $pluginFolderName) {
    ...
    $settingsArray = array(
        ...
        'epaymets_debits_tab_info' => $options['epaymets_debits_tab_info'] ? htmlspecialchars($options['epaymets_debits_tab_info']) : '',
        'epaymets_receipts_tab_info' => $options['epaymets_receipts_tab_info'] ? htmlspecialchars($options['epaymets_receipts_tab_info']) : '',
