...
function setAppsSettings($options, $pluginFolderName)
{
   ...
   $settingsArray = array(
      ...
      'benefits_afm_required' => isset($options['benefits_afm_required']) && $options['benefits_afm_required'] == 'on' ? true : false,
      ...
      'carpooling_afm_required' => isset($options['carpooling_afm_required']) && $options['carpooling_afm_required'] == 'on' ? true : false,
      ...
      'epayments_afm_required' => isset($options['epayments_afm_required']) && $options['epayments_afm_required'] == 'on' ? true : false,
      ...
      'kliseis_afm_required' => isset($options['kliseis_afm_required']) && $options['kliseis_afm_required'] == 'on' ? true : false,
      ...
      'eidopoiitiria_afm_required' => isset($options['eidopoiitiria_afm_required']) && $options['eidopoiitiria_afm_required'] == 'on' ? true : false,
      ...
      'katastimata_afm_required' => isset($options['katastimata_afm_required']) && $options['katastimata_afm_required'] == 'on' ? true : false,
      ...
      'koinoxristoi_afm_required' => isset($options['koinoxristoi_afm_required']) && $options['koinoxristoi_afm_required'] == 'on' ? true : false,
      ...
      'diakanonismoi_afm_required' => isset($options['diakanonismoi_afm_required']) && $options['diakanonismoi_afm_required'] == 'on' ? true : false,
      ...
      'shde_afm_required' => isset($options['shde_afm_required']) && $options['shde_afm_required'] == 'on' ? true : false,
      ...
      'rantevou_afm_required' => isset($options['rantevou_afm_required']) && $options['rantevou_afm_required'] == 'on' ? true : false,
      ...
      'proslipseis_afm_required' => isset($options['proslipseis_afm_required']) && $options['proslipseis_afm_required'] == 'on' ? true : false,
