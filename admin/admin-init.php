      ...
      <div class="card-body">
         <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
               ...
               <button class="nav-link" id="nav-koin-aitiseis-tab" data-bs-toggle="tab" data-bs-target="#nav-koin-aitiseis" type="button" role="tab" aria-controls="nav-koin-aitiseis" aria-selected="false">Αιτήσεις Κοινοχρήστων</button>
         ...
         <form action="options.php" method="post" class="mt-4">
            ...
            <div class="tab-content" id="nav-tabContent">
               ...
               <div class="tab-pane fade" id="nav-koin-aitiseis" role="tabpanel" aria-labelledby="nav-koin-aitiseis-tab">
...
function egr_register_settings()
{
   ...
   add_settings_field('egr_plugin_setting_benefits_tab_info_en', 'Οδηγίες (EN) (benefits_tab_info_en)', 'egr_plugin_setting_benefits_tab_info_en', 'egr_domes_plugin', 'domes_settings');
   ...
   add_settings_field('egr_plugin_setting_carpooling_tab_info_en', 'Γενικές Οδηγίες (EN) (carpooling_tab_info_en)', 'egr_plugin_setting_carpooling_tab_info_en', 'egr_carpooling_plugin', 'carpooling_settings');
   ...
   add_settings_field('egr_plugin_setting_order_carpooling', 'Σειρά Εμφάνισης (order_carpooling)', 'egr_plugin_setting_order_carpooling', 'egr_carpooling_plugin', 'carpooling_settings');
   ...
   add_settings_field('egr_plugin_setting_epayments_debits_tab_info', 'Οδηγίες Οφειλών (epayments_debits_tab_info)', 'egr_plugin_setting_epayments_debits_tab_info', 'egr_epayments_plugin', 'epayments_settings');
   add_settings_field('egr_plugin_setting_epayments_debits_tab_info_en', 'Οδηγίες Οφειλών (EN) (epayments_debits_tab_info_en)', 'egr_plugin_setting_epayments_debits_tab_info_en', 'egr_epayments_plugin', 'epayments_settings');
   add_settings_field('egr_plugin_setting_epayments_receipts_tab_info', 'Οδηγίες Ιστορικού Πληρωμών (epayments_receipts_tab_info)', 'egr_plugin_setting_epayments_receipts_tab_info', 'egr_epayments_plugin', 'epayments_settings');
   add_settings_field('egr_plugin_setting_epayments_receipts_tab_info_en', 'Οδηγίες Ιστορικού Πληρωμών (EN) (epayments_receipts_tab_info_en)', 'egr_plugin_setting_epayments_receipts_tab_info_en', 'egr_epayments_plugin', 'epayments_settings');
   ...
   add_settings_field('egr_plugin_setting_order_epayments', 'Σειρά Εμφάνισης (order_epayments)', 'egr_plugin_setting_order_epayments', 'egr_epayments_plugin', 'epayments_settings');
   ...
   add_settings_field('egr_plugin_setting_kliseis_description_en', 'Περιγραφή (EN) (kliseis_description_en)', 'egr_plugin_setting_kliseis_description_en', 'egr_kliseis_plugin', 'kliseis_settings');
   add_settings_field('egr_plugin_setting_kliseis_debits_tab_info', 'Οδηγίες Οφειλών (kliseis_debits_tab_info)', 'egr_plugin_setting_kliseis_debits_tab_info', 'egr_kliseis_plugin', 'kliseis_settings');
   add_settings_field('egr_plugin_setting_kliseis_debits_tab_info_en', 'Οδηγίες Οφειλών (EN) (kliseis_debits_tab_info_en)', 'egr_plugin_setting_kliseis_debits_tab_info_en', 'egr_kliseis_plugin', 'kliseis_settings');
   add_settings_field('egr_plugin_setting_kliseis_receipts_tab_info', 'Οδηγίες Ιστορικού Πληρωμών (kliseis_receipts_tab_info)', 'egr_plugin_setting_kliseis_receipts_tab_info', 'egr_kliseis_plugin', 'kliseis_settings');
   add_settings_field('egr_plugin_setting_kliseis_receipts_tab_info_en', 'Οδηγίες Ιστορικού Πληρωμών (EN) (kliseis_receipts_tab_info_en)', 'egr_plugin_setting_kliseis_receipts_tab_info_en', 'egr_kliseis_plugin', 'kliseis_settings');
   add_settings_field('egr_plugin_setting_kliseis_unauthorized_info', 'Οδηγίες Unauthorized (kliseis_unauthorized_info)', 'egr_plugin_setting_kliseis_unauthorized_info', 'egr_kliseis_plugin', 'kliseis_settings');
   add_settings_field('egr_plugin_setting_kliseis_unauthorized_info_en', 'Οδηγίες Unauthorized (EN) (kliseis_unauthorized_info_en)', 'egr_plugin_setting_kliseis_unauthorized_info_en', 'egr_kliseis_plugin', 'kliseis_settings');
   add_settings_field('egr_plugin_setting_order_kliseis', 'Σειρά Εμφάνισης (order_kliseis)', 'egr_plugin_setting_order_kliseis', 'egr_kliseis_plugin', 'kliseis_settings');
   ...
   add_settings_field('egr_plugin_setting_order_eidopoiitiria', 'Σειρά Εμφάνισης (order_eidopoiitiria)', 'egr_plugin_setting_order_eidopoiitiria', 'egr_eidopoiitiria_plugin', 'eidopoiitiria_settings');
   ...
   add_settings_field('egr_plugin_setting_order_shde', 'Σειρά Εμφάνισης (order_shde)', 'egr_plugin_setting_order_shde', 'egr_diakinisi_plugin', 'shde_settings');
   ...
   add_settings_field('egr_plugin_setting_order_rantevou', 'Σειρά Εμφάνισης (order_rantevou)', 'egr_plugin_setting_order_rantevou', 'egr_rantevou_plugin', 'rantevou_settings');
...
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_carpooling_tab_title' name='egr_webapps_plugin_options[carpooling_tab_title]' type='text' value='" . esc_attr(isset($options['carpooling_tab_title']) ? $options['carpooling_tab_title'] : '') . "' />";
}

function egr_plugin_setting_carpooling_tab_title_en()
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_carpooling_tab_title_en' name='egr_webapps_plugin_options[carpooling_tab_title_en]' type='text' value='" . esc_attr(isset($options['carpooling_tab_title_en']) ? $options['carpooling_tab_title_en'] : '') . "' />";
}
...
function egr_plugin_setting_carpooling_tab_info_en()
{
   $options = get_option('egr_webapps_plugin_options'); ?>

   <div class="editor-wrapper egr_plugin_setting_carpooling_tab_info_en_editor">
      <?php echo "<input type='hidden' id='egr_plugin_setting_carpooling_tab_info_en' name='egr_webapps_plugin_options[carpooling_tab_info_en]' value='" . esc_attr(isset($options['carpooling_tab_info_en']) ? $options['carpooling_tab_info_en'] : '') . "' />"; ?>
      <div id="egr_plugin_setting_carpooling_tab_info_en_editor" class="editor"></div>
   </div>
<?php }
...
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_epayments_tab_title' name='egr_webapps_plugin_options[epayments_tab_title]' type='text' value='" . esc_attr(isset($options['epayments_tab_title']) ? $options['epayments_tab_title'] : '') . "' />";
}

function egr_plugin_setting_epayments_tab_title_en()
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_epayments_tab_title_en' name='egr_webapps_plugin_options[epayments_tab_title_en]' type='text' value='" . esc_attr(isset($options['epayments_tab_title_en']) ? $options['epayments_tab_title_en'] : '') . "' />";
}
...
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_kliseis_tab_title' name='egr_webapps_plugin_options[kliseis_tab_title]' type='text' value='" . esc_attr(isset($options['kliseis_tab_title']) ? $options['kliseis_tab_title'] : '') . "' />";
}

function egr_plugin_setting_kliseis_tab_title_en()
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_kliseis_tab_title_en' name='egr_webapps_plugin_options[kliseis_tab_title_en]' type='text' value='" . esc_attr(isset($options['kliseis_tab_title_en']) ? $options['kliseis_tab_title_en'] : '') . "' />";
}
...
function egr_plugin_setting_kliseis_unauthorized_info()
{
   $options = get_option('egr_webapps_plugin_options'); ?>

   <div class="editor-wrapper egr_plugin_setting_kliseis_unauthorized_info_editor">
      <?php echo "<input type='hidden' id='egr_plugin_setting_kliseis_unauthorized_info' name='egr_webapps_plugin_options[kliseis_unauthorized_info]' value='" . esc_attr(isset($options['kliseis_unauthorized_info']) ? $options['kliseis_unauthorized_info'] : '') . "' />"; ?>
      <div id="egr_plugin_setting_kliseis_unauthorized_info_editor" class="editor"></div>
   </div>
<?php }

function egr_plugin_setting_kliseis_unauthorized_info_en()
{
   $options = get_option('egr_webapps_plugin_options'); ?>

   <div class="editor-wrapper egr_plugin_setting_kliseis_unauthorized_info_en_editor">
      <?php echo "<input type='hidden' id='egr_plugin_setting_kliseis_unauthorized_info_en' name='egr_webapps_plugin_options[kliseis_unauthorized_info_en]' value='" . esc_attr(isset($options['kliseis_unauthorized_info_en']) ? $options['kliseis_unauthorized_info_en'] : '') . "' />"; ?>
      <div id="egr_plugin_setting_kliseis_unauthorized_info_en_editor" class="editor"></div>
   </div>
<?php }
...
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_eidopoiitiria_tab_title' name='egr_webapps_plugin_options[eidopoiitiria_tab_title]' type='text' value='" . esc_attr(isset($options['eidopoiitiria_tab_title']) ? $options['eidopoiitiria_tab_title'] : '') . "' />";
}

function egr_plugin_setting_eidopoiitiria_tab_title_en()
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_eidopoiitiria_tab_title_en' name='egr_webapps_plugin_options[eidopoiitiria_tab_title_en]' type='text' value='" . esc_attr(isset($options['eidopoiitiria_tab_title_en']) ? $options['eidopoiitiria_tab_title_en'] : '') . "' />";
}
...
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_katastimata_tab_title' name='egr_webapps_plugin_options[katastimata_tab_title]' type='text' value='" . esc_attr(isset($options['katastimata_tab_title']) ? $options['katastimata_tab_title'] : '') . "' />";
}

function egr_plugin_setting_katastimata_tab_title_en()
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_katastimata_tab_title_en' name='egr_webapps_plugin_options[katastimata_tab_title_en]' type='text' value='" . esc_attr(isset($options['katastimata_tab_title_en']) ? $options['katastimata_tab_title_en'] : '') . "' />";
}
...
//KOINOXRHSTOI
function egr_plugin_setting_is_koinoxristoi()
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_is_koinoxristoi' name='egr_webapps_plugin_options[koinoxristoi]' type='checkbox' " . esc_attr(isset($options['koinoxristoi']) ? 'checked=checked' : '') . " />";
}
...
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_koinoxristoi_tab_title' name='egr_webapps_plugin_options[koinoxristoi_tab_title]' type='text' value='" . esc_attr(isset($options['koinoxristoi_tab_title']) ? $options['koinoxristoi_tab_title'] : '') . "' />";
}

function egr_plugin_setting_koinoxristoi_tab_title_en()
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_koinoxristoi_tab_title_en' name='egr_webapps_plugin_options[koinoxristoi_tab_title_en]' type='text' value='" . esc_attr(isset($options['koinoxristoi_tab_title_en']) ? $options['koinoxristoi_tab_title_en'] : '') . "' />";
}
...
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_diakanonismoi_tab_title' name='egr_webapps_plugin_options[diakanonismoi_tab_title]' type='text' value='" . esc_attr(isset($options['diakanonismoi_tab_title']) ? $options['diakanonismoi_tab_title'] : '') . "' />";
}

function egr_plugin_setting_diakanonismoi_tab_title_en()
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_diakanonismoi_tab_title_en' name='egr_webapps_plugin_options[diakanonismoi_tab_title_en]' type='text' value='" . esc_attr(isset($options['diakanonismoi_tab_title_en']) ? $options['diakanonismoi_tab_title_en'] : '') . "' />";
}
...
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_shde_tab_title' name='egr_webapps_plugin_options[shde_tab_title]' type='text' value='" . esc_attr(isset($options['shde_tab_title']) ? $options['shde_tab_title'] : '') . "' />";
}

function egr_plugin_setting_shde_tab_title_en()
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_shde_tab_title_en' name='egr_webapps_plugin_options[shde_tab_title_en]' type='text' value='" . esc_attr(isset($options['shde_tab_title_en']) ? $options['shde_tab_title_en'] : '') . "' />";
}
...
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_rantevou_tab_title' name='egr_webapps_plugin_options[rantevou_tab_title]' type='text' value='" . esc_attr(isset($options['rantevou_tab_title']) ? $options['rantevou_tab_title'] : '') . "' />";
}

function egr_plugin_setting_rantevou_tab_title_en()
{
   $options = get_option('egr_webapps_plugin_options');
   echo "<input id='egr_plugin_setting_rantevou_tab_title_en' name='egr_webapps_plugin_options[rantevou_tab_title_en]' type='text' value='" . esc_attr(isset($options['rantevou_tab_title_en']) ? $options['rantevou_tab_title_en'] : '') . "' />";
}
...
function egr_plugin_setting_proslipseis_tab_info_en()
{
   $options = get_option('egr_webapps_plugin_options'); ?>

   <div class="editor-wrapper egr_plugin_setting_proslipseis_tab_info_en_editor">
      <?php echo "<input type='hidden' id='egr_plugin_setting_proslipseis_tab_info_en' name='egr_webapps_plugin_options[proslipseis_tab_info_en]' value='" . esc_attr(isset($options['proslipseis_tab_info_en']) ? $options['proslipseis_tab_info_en'] : '') . "' />"; ?>
      <div id="egr_plugin_setting_proslipseis_tab_info_en_editor" class="editor"></div>
   </div>
<?php }
